...
<style>
  ...
  .bg-smart{
    /* background-color: rgb(101, 77, 196) !important; */
    background-color: #77BDE5 !important;
  }
...
<body>
  <div class="container-scroller">
    ...
    <nav class="sidebar bg-smart sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        @include('template.sidebar')
      </ul>
    </nav>
    <!-- partial -->
    <div class="container-fluid bg-utama page-body-wrapper">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-menu-wrapper bg-utama d-flex align-items-stretch">
          <button class="navbar-toggler bg-utama navbar-toggler align-self-center" type="button" data-toggle="minimize">
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            ...
            <div>
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block"> Rumbel Qsmart</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
